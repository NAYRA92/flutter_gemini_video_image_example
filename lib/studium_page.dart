...
List<String> studiumDetails = [
  //1
  '''
• 💡 الفكرة: معسكر مهاري + لياقي باستخدام الذكاء الاصطناعي.
...
//3
  '''
 • 💡 الفكرة: جلسات تكتيكية مع الذكاء الاصطناعي + محاضرات تطوير المدربين.

 • 🏖 البيئة: ملاعب منظمة + قاعات تعليمية.
...
''',
  ...
  //5
  '''
 • 💡 الفكرة: ورش تدريبية للاعبين الناشئين + تحليل الأداء باستخدام AI.
 • 🏖 البيئة: مرافق حديثة ومتكاملة تدعم التدريب العملي والتطبيقات التقنية.
